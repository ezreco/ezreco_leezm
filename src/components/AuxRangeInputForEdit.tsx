...
interface AuxRangeInputForEditProps {
  values: RangeValue[];
...
const AuxRangeInputForEdit: React.FC<AuxRangeInputForEditProps> = ({
  values,
    ...
    <div className={`flex items-center w-full gap-[16px]`}>
      ...
      >
        <div
          className={`relative size-full ${
            onSend ? "border border-[#D5D8DC] rounded-[12px]" : ""
          }`}
        >
          {/* Background */}
      ...
      {onSend && (
        <button
          ...
          className={`bg-[#0106ff] box-border flex items-center justify-center rounded-[19px] hover:bg-[#0106ff]/90 transition-colors ${
            sendButtonText
...
export default AuxRangeInputForEdit;
